...
|------|------------------|-------------|
| `icon.jpg` | 1024×1024 | App icon (used by iOS and Android) |
| `splash.jpg` | 1284×2778 or similar | Splash screen image |
| `adaptive-icon.jpg` | 1024×1024 | Android adaptive icon (foreground) |
